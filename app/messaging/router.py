...
_HELP = (
    ...
    "/tasks  — 목록 보기 + 완료·삭제 버튼\n"
    "/done <번호>  — 완료 처리\n"
    "/del <번호>  — 삭제\n"
    "/edit <번호> <새내용>  — 내용·날짜·섹션 수정\n"
    "  날짜 키워드: 오늘·내일·이번 주·월~일요일·2026-07-01\n"
    "  섹션: 오늘 / 이번 주 / 언제든지 (날짜로 자동 분류)\n"
    "\n"
    "**[ 매일 쓰는 명령 ]**\n"
    ...
    "/review  — 후보 한 건씩 카드로 검토 (✅ 승격 / ⏭ 건너뛰기 / 🗑 삭제 / ⛔ 종료)\n"
    "/candidates  — 생성된 후보 목록 확인\n"
    "/promote <경로>  — 후보 → 공식 지식으로 승격\n"
    "/worklog  — 오늘 작업 회고 작성\n"
    "\n"
    "**[ 블로그 ]**\n"
    "/write <주제>  — 블로그 초안 작성\n"
    "/list  — 초안 목록\n"
    "/preview [경로]  — 초안 미리보기 (기본: latest)\n"
    "/revise [경로]  — 초안 다듬기\n"
    "/export [경로]  — 티스토리용 HTML 변환\n"
    "/publish <URL>  — 게시 완료 기록 (latest 대상)\n"
    "\n"
    "**[ 가끔 쓰는 명령 ]**\n"
    "/resume  — 이력서 초안 생성\n"
